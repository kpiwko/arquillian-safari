...
public class RegisterCallback extends AbstractFragmentActivityCallback<HeaderAndBody>{

	private static final long serialVersionUID = 1L;
	private static final String TAG = RegisterCallback.class.getSimpleName();
	...
	public void onSuccess(HeaderAndBody data) {
		getFragmentActivity().startActivity(new Intent(getFragmentActivity(),
				TodoActivity.class));
